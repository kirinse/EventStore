...
namespace EventStore.Core.Tests.Services.PersistentSubscription {
		...
		public void live_subscription_pushes_events_to_client() {
			...
			var sub = new Core.Services.PersistentSubscription.PersistentSubscription(
				PersistentSubscriptionParamsBuilder.CreateFor("streamName", "groupName")
					...
					.StartFromCurrent());
			reader.Load(null);
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), envelope, 10, "foo", "bar");
		...
		public void live_subscription_with_round_robin_two_pushes_events_to_both() {
			...
			var sub = new Core.Services.PersistentSubscription.PersistentSubscription(
				PersistentSubscriptionParamsBuilder.CreateFor("streamName", "groupName")
					...
					.StartFromCurrent());
			reader.Load(null);
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), envelope1, 10, "foo", "bar");
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-2", () => throw new System.NotImplementedException(), envelope2, 10, "foo", "bar");
			sub.NotifyLiveSubscriptionMessage(Helper.BuildFakeEvent(Guid.NewGuid(), "type", "streamName", 0));
	...
	public class Checkpointing {
		...
		public void subscription_does_not_write_checkpoint_when_max_not_hit() {
			...
			sub.AddClient(corrid, Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), envelope1, 10, "foo", "bar");
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-2", () => throw new System.NotImplementedException(), envelope1, 10, "foo", "bar");
			var id = Guid.NewGuid();
			sub.HandleReadCompleted(new[] {
		...
		public void
			...
			sub.AddClient(clientCorrelationId, clientConnectionId, "connection-1", () => throw new System.NotImplementedException(), new FakeEnvelope(), 10, "foo", "bar");
	...
	public class TimeoutTests {
		...
		public void messages_get_timed_out_and_resent_to_clients() {
			...
			reader.Load(null);
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), envelope1, 1, "foo", "bar");
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-2", () => throw new System.NotImplementedException(), envelope1, 1, "foo", "bar");
			var id1 = Guid.NewGuid();
			var id2 = Guid.NewGuid();
			sub.HandleReadCompleted(new[] {
				Helper.BuildFakeEvent(id1, "type", "streamName", 0),
		...
		public void timeout_park_correctly_tracks_the_available_client_slots() {
			...
			var sub = new Core.Services.PersistentSubscription.PersistentSubscription(
				PersistentSubscriptionParamsBuilder.CreateFor("streamName", "groupName")
					...
					.StartFromBeginning());
			reader.Load(null);
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), envelope1, 2, "foo", "bar");
	...
	public class NAKTests {
		...
		public void explicit_nak_with_park_correctly_tracks_the_available_client_slots() {
			...
			reader.Load(null);
			var corrid = Guid.NewGuid();
			sub.AddClient(corrid, Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), envelope1, 1, "foo", "bar");
	...
	public class AddingClientTests {
		...
		public void adding_a_client_adds_the_client() {
			...
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), new FakeEnvelope(), 1, "foo", "bar");
	...
	public class RemoveClientTests {
		...
		public void unsubscribing_a_client_retries_inflight_messages_immediately() {
			...
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), client1Envelope, 10, "foo", "bar");
			var client2Id = Guid.NewGuid();
			sub.AddClient(client2Id, Guid.NewGuid(), "connection-2", () => throw new System.NotImplementedException(), client2Envelope, 10, "foo", "bar");
		...
		public void disconnecting_a_client_retries_inflight_messages_immediately() {
			...
			sub.AddClient(Guid.NewGuid(), connectionId, "connection-2", () => throw new System.NotImplementedException(), client2Envelope, 10, "foo", "bar");
