...
namespace EventStore.Core.Tests.Services.PersistentSubscription {
	...
	public class PinnedConsumerStrategyTests {
		...
		public void live_subscription_with_pinned_pushes_events_to_same_client_for_stream_id() {
			...
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-2", () => throw new System.NotImplementedException(), client2Envelope, 10, "foo", "bar");
		...
		public void new_subscription_gets_work() {
			...
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-3", () => throw new System.NotImplementedException(), client3Envelope, 10, "foo", "bar");
		...
		public void bad_availablecapacity_scneanrio_causing_null_reference() {
			...
			sub.AddClient(Guid.NewGuid(), conn1Id, "connection-1", () => throw new System.NotImplementedException(), client1Envelope, 10, "foo", "bar");
			...
			sub.AddClient(Guid.NewGuid(), conn2Id, "connection-2", () => throw new System.NotImplementedException(), client2Envelope, 10, "foo", "bar");
		...
		public void disconnected_client_has_assigned_streams_sent_to_another_client() {
			...
			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), client1Envelope, 10, "foo", "bar");
			var client2Id = Guid.NewGuid();
			sub.AddClient(Guid.NewGuid(), client2Id, "connection-2", () => throw new System.NotImplementedException(), client2Envelope, 10, "foo", "bar");
		...
		public void available_capacity_is_tracked() {
			...
			sub.AddClient(Guid.NewGuid(), client1Id, "connection-1", () => throw new System.NotImplementedException(), client1Envelope, 14, "foo", "bar");
		...
		public void available_capacity_is_tracked_with_acked_messages() {
			...
			sub.AddClient(correlationId1, Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), client1Envelope, 14, "foo", "bar");
			Assert.That(consumerStrategy.AvailableCapacity, Is.EqualTo(14));

			var correlationId2 = Guid.NewGuid();
			sub.AddClient(correlationId2, Guid.NewGuid(), "connection-2", () => throw new System.NotImplementedException(), client2Envelope, 10, "foo", "bar");
		...
		public void events_are_skipped_if_assigned_client_full() {
			...
			sub.AddClient(correlationId, Guid.NewGuid(), "connection-1", () => throw new System.NotImplementedException(), client1Envelope, 1, "foo", "bar");

			sub.AddClient(Guid.NewGuid(), Guid.NewGuid(), "connection-2", () => throw new System.NotImplementedException(), client2Envelope, 1, "foo", "bar");
